...
public class CreditDecisionWorkflow extends AbstractWorkflowDefinition<WorkflowState> {
  ...
  private static final WorkflowState INTERNAL_BLACKLIST = new SimpleState("internalBlacklist", start,
      "Reject internally blacklisted customers");
  private static final WorkflowState DECISION_ENGINE = new SimpleState("decisionEngine",
      "Check if application ok for decision engine");
  private static final WorkflowState SAT_QUERY = new SimpleState("satQuery", "Query customer credit rating from SAT");
  private static final WorkflowState MANUAL_DECISION = new SimpleState("manualDecision", manual,
      "Manually approve or reject the application");
  static final WorkflowState APPROVED = new SimpleState("approved", end, "Credit Decision Approved");
  static final WorkflowState REJECTED = new SimpleState("rejected", end, "Credit Decision Rejected");
