...
angular controller|PascalCase|angular.controller('FrontPageCtrl', ...
angular directive|camelCase|angular.directive('workflowExecutorTable', ...
angular service|PascalCase|angular.factory('ManageWorkflow', ...
