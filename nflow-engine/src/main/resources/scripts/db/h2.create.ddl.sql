...
alter table nflow_archive_workflow add constraint fk_workflow_archive_parent
...
alter table nflow_archive_workflow add constraint fk_workflow_archive_root
  foreign key (root_workflow_id) references nflow_archive_workflow (id) on delete cascade;
