...
alter table nflow_workflow add status varchar(32) not null default 'inProgress' check status in ('created', 'executing', 'inProgress', 'finished', 'manual', 'stopped', 'paused');
