...
public class NextProcessingAction {
  ...
  private final WorkflowProcessingState nextState;
  private final String reason;

  private NextProcessingAction(DateTime activation, WorkflowProcessingState nextState, String reason) {
    this.reason = reason;
   ...
   */
  public WorkflowProcessingState getNextState() {
    return nextState;
  }
   ...
   */
  public static NextProcessingAction retryAfter(DateTime activation, String reason) {
    assertNotNull(activation, "Activation can not be null");
    return new NextProcessingAction(activation, null, reason);
  }
   ...
   * @return A valid {@code NextAction} value.
   */
  public static NextProcessingAction moveToStateAfter(WorkflowProcessingState nextState, DateTime activation, String reason) {
    assertNotNull(nextState, "Next state can not be null");
    assertNotNull(activation, "Activation can not be null");
    return new NextProcessingAction(activation, nextState, reason);
  }
   ...
   * @return A valid {@code NextAction} value.
   */
  public static NextProcessingAction moveToState(WorkflowProcessingState nextState, String reason) {
    assertNotNull(nextState, "Next state can not be null");
    return new NextProcessingAction(now(), nextState, reason);
  }
   ...
   * @return A valid {@code NextAction} value.
   */
  public static NextProcessingAction stopInState(WorkflowProcessingState finalState, String reason) {
    assertNotNull(finalState, "State can not be null");
    assertFinalState(finalState);
    return new NextProcessingAction(null, finalState, reason);
  }

  private static void assertFinalState(WorkflowProcessingState state) {
